...
} Extension_TextureOpWrapMirroredRepeat;

/**
 * アプリの初期化を行う
 */
void sample_TextureOpWrapMirroredRepeat_initialize( GLApplication *app) {
    // サンプルアプリ用のメモリを確保する
    app->extension = (Extension_TextureOpWrapMirroredRepeat*) malloc(sizeof(Extension_TextureOpWrapMirroredRepeat));
    // サンプルアプリ用データを取り出す
    Extension_TextureOpWrapMirroredRepeat *extension = (Extension_TextureOpWrapMirroredRepeat*) app->extension;
 ...
 * レンダリングエリアが変更された
 */
void sample_TextureOpWrapMirroredRepeat_resized( GLApplication *app) {
    // 描画領域を設定する
 ...
 * 毎秒60回前後呼び出される。
 */
void sample_TextureOpWrapMirroredRepeat_rendering( GLApplication *app) {
    // サンプルアプリ用データを取り出す
    Extension_TextureOpWrapMirroredRepeat *extension = (Extension_TextureOpWrapMirroredRepeat*) app->extension;
 ...
 * アプリのデータ削除を行う
 */
void sample_TextureOpWrapMirroredRepeat_destroy( GLApplication *app) {
    // サンプルアプリ用データを取り出す
    Extension_TextureOpWrapMirroredRepeat *extension = (Extension_TextureOpWrapMirroredRepeat*) app->extension;
