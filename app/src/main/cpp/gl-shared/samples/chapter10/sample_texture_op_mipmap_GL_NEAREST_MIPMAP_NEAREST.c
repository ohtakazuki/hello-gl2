...
} Extension_TextureOpMipmapNMN;

/**
 * アプリの初期化を行う
 */
void sample_TextureOpMipmapNMN_initialize(GLApplication *app) {
    // サンプルアプリ用のメモリを確保する
    app->extension = (Extension_TextureOpMipmapNMN*) malloc(sizeof(Extension_TextureOpMipmapNMN));
    // サンプルアプリ用データを取り出す
    Extension_TextureOpMipmapNMN *extension = (Extension_TextureOpMipmapNMN*) app->extension;
 ...
 * レンダリングエリアが変更された
 */
void sample_TextureOpMipmapNMN_resized(GLApplication *app) {
    // 描画領域を設定する
 ...
 * 毎秒60回前後呼び出される。
 */
void sample_TextureOpMipmapNMN_rendering(GLApplication *app) {
    // サンプルアプリ用データを取り出す
    Extension_TextureOpMipmapNMN *extension = (Extension_TextureOpMipmapNMN*) app->extension;
 ...
 * アプリのデータ削除を行う
 */
void sample_TextureOpMipmapNMN_destroy(GLApplication *app) {
    // サンプルアプリ用データを取り出す
    Extension_TextureOpMipmapNMN *extension = (Extension_TextureOpMipmapNMN*) app->extension;
