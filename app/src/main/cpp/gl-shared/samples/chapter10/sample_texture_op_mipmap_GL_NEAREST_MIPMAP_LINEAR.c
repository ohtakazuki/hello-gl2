...
} Extension_TextureOpMipmapNML;

/**
 * アプリの初期化を行う
 */
void sample_TextureOpMipmapNML_initialize(GLApplication *app) {
    // サンプルアプリ用のメモリを確保する
    app->extension = (Extension_TextureOpMipmapNML*) malloc(sizeof(Extension_TextureOpMipmapNML));
    // サンプルアプリ用データを取り出す
    Extension_TextureOpMipmapNML *extension = (Extension_TextureOpMipmapNML*) app->extension;
 ...
 * レンダリングエリアが変更された
 */
void sample_TextureOpMipmapNML_resized(GLApplication *app) {
    // 描画領域を設定する
 ...
 * 毎秒60回前後呼び出される。
 */
void sample_TextureOpMipmapNML_rendering(GLApplication *app) {
    // サンプルアプリ用データを取り出す
    Extension_TextureOpMipmapNML *extension = (Extension_TextureOpMipmapNML*) app->extension;
 ...
 * アプリのデータ削除を行う
 */
void sample_TextureOpMipmapNML_destroy(GLApplication *app) {
    // サンプルアプリ用データを取り出す
    Extension_TextureOpMipmapNML *extension = (Extension_TextureOpMipmapNML*) app->extension;
