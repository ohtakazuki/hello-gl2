...
} Extension_TextureOpMipmapLML;

/**
 * アプリの初期化を行う
 */
void sample_TextureOpMipmapLML_initialize(GLApplication *app) {
    // サンプルアプリ用のメモリを確保する
    app->extension = (Extension_TextureOpMipmapLML*) malloc(sizeof(Extension_TextureOpMipmapLML));
    // サンプルアプリ用データを取り出す
    Extension_TextureOpMipmapLML *extension = (Extension_TextureOpMipmapLML*) app->extension;
 ...
 * レンダリングエリアが変更された
 */
void sample_TextureOpMipmapLML_resized(GLApplication *app) {
    // 描画領域を設定する
 ...
 * 毎秒60回前後呼び出される。
 */
void sample_TextureOpMipmapLML_rendering(GLApplication *app) {
    // サンプルアプリ用データを取り出す
    Extension_TextureOpMipmapLML *extension = (Extension_TextureOpMipmapLML*) app->extension;
 ...
 * アプリのデータ削除を行う
 */
void sample_TextureOpMipmapLML_destroy(GLApplication *app) {
    // サンプルアプリ用データを取り出す
    Extension_TextureOpMipmapLML *extension = (Extension_TextureOpMipmapLML*) app->extension;
