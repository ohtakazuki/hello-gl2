...
} Extension_TextureOpWrapClamp;

/**
 * アプリの初期化を行う
 */
void sample_TextureOpWrapClamp_initialize( GLApplication *app) {
    // サンプルアプリ用のメモリを確保する
    app->extension = (Extension_TextureOpWrapClamp*) malloc(sizeof(Extension_TextureOpWrapClamp));
    // サンプルアプリ用データを取り出す
    Extension_TextureOpWrapClamp *extension = (Extension_TextureOpWrapClamp*) app->extension;
 ...
 * レンダリングエリアが変更された
 */
void sample_TextureOpWrapClamp_resized( GLApplication *app) {
    // 描画領域を設定する
 ...
 * 毎秒60回前後呼び出される。
 */
void sample_TextureOpWrapClamp_rendering( GLApplication *app) {
    // サンプルアプリ用データを取り出す
    Extension_TextureOpWrapClamp *extension = (Extension_TextureOpWrapClamp*) app->extension;
 ...
 * アプリのデータ削除を行う
 */
void sample_TextureOpWrapClamp_destroy( GLApplication *app) {
    // サンプルアプリ用データを取り出す
    Extension_TextureOpWrapClamp *extension = (Extension_TextureOpWrapClamp*) app->extension;
