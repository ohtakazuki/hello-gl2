...
} Extension_TextureOpWrapRepeat;

/**
 * アプリの初期化を行う
 */
void sample_TextureOpWrapRepeat_initialize( GLApplication *app) {
    // サンプルアプリ用のメモリを確保する
    app->extension = (Extension_TextureOpWrapRepeat*) malloc(sizeof(Extension_TextureOpWrapRepeat));
    // サンプルアプリ用データを取り出す
    Extension_TextureOpWrapRepeat *extension = (Extension_TextureOpWrapRepeat*) app->extension;
 ...
 * レンダリングエリアが変更された
 */
void sample_TextureOpWrapRepeat_resized( GLApplication *app) {
    // 描画領域を設定する
 ...
 * 毎秒60回前後呼び出される。
 */
void sample_TextureOpWrapRepeat_rendering( GLApplication *app) {
    // サンプルアプリ用データを取り出す
    Extension_TextureOpWrapRepeat *extension = (Extension_TextureOpWrapRepeat*) app->extension;
 ...
 * アプリのデータ削除を行う
 */
void sample_TextureOpWrapRepeat_destroy( GLApplication *app) {
    // サンプルアプリ用データを取り出す
    Extension_TextureOpWrapRepeat *extension = (Extension_TextureOpWrapRepeat*) app->extension;
