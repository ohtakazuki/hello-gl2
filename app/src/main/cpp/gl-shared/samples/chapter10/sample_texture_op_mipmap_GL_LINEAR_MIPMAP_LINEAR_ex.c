...
} Extension_TextureOpMipmapLML_ex;

/**
 * アプリの初期化を行う
 */
void sample_TextureOpMipmapLML_ex_initialize(GLApplication *app) {
    // サンプルアプリ用のメモリを確保する
    app->extension = (Extension_TextureOpMipmapLML_ex*) malloc(sizeof(Extension_TextureOpMipmapLML_ex));
    // サンプルアプリ用データを取り出す
    Extension_TextureOpMipmapLML_ex *extension = (Extension_TextureOpMipmapLML_ex*) app->extension;
 ...
 * レンダリングエリアが変更された
 */
void sample_TextureOpMipmapLML_ex_resized(GLApplication *app) {
    // 描画領域を設定する
 ...
 * 毎秒60回前後呼び出される。
 */
void sample_TextureOpMipmapLML_ex_rendering(GLApplication *app) {
    // サンプルアプリ用データを取り出す
    Extension_TextureOpMipmapLML_ex *extension = (Extension_TextureOpMipmapLML_ex*) app->extension;
 ...
 * アプリのデータ削除を行う
 */
void sample_TextureOpMipmapLML_ex_destroy(GLApplication *app) {
    // サンプルアプリ用データを取り出す
    Extension_TextureOpMipmapLML_ex *extension = (Extension_TextureOpMipmapLML_ex*) app->extension;
