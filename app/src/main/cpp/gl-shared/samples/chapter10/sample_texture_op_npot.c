...
} Extension_TextureOpNpot;

/**
 * アプリの初期化を行う
 */
void sample_TextureOpNpot_initialize( GLApplication *app) {
    // サンプルアプリ用のメモリを確保する
    app->extension = (Extension_TextureOpNpot*) malloc(sizeof(Extension_TextureOpNpot));
    // サンプルアプリ用データを取り出す
    Extension_TextureOpNpot *extension = (Extension_TextureOpNpot*) app->extension;
...

    {
        ...
        // npotテクスチャは基本的にGL_CLAMP_TO_EDGEを設定する
 ...
 * レンダリングエリアが変更された
 */
void sample_TextureOpNpot_resized( GLApplication *app) {
    // 描画領域を設定する
 ...
 * 毎秒60回前後呼び出される。
 */
void sample_TextureOpNpot_rendering( GLApplication *app) {
    // サンプルアプリ用データを取り出す
    Extension_TextureOpNpot *extension = (Extension_TextureOpNpot*) app->extension;
 ...
 * アプリのデータ削除を行う
 */
void sample_TextureOpNpot_destroy( GLApplication *app) {
    // サンプルアプリ用データを取り出す
    Extension_TextureOpNpot *extension = (Extension_TextureOpNpot*) app->extension;
